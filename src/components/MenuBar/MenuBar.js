...
export const MenuBar = props => {
        ...
        const toggleDroppedDown = () => {setDropDown(!droppedDown)}
        ...
        const listItemsMobile = props.menuItems.map((menuItemIterator, i) =>
            <MenuItem key={menuItemIterator.id} index={i} menuItem={menuItemIterator} mobile menuItemAmount={menuItemAmount}/>);
